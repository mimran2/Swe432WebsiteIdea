	...
	var FloatButton2 = React.createClass({
		getInitialState: function(){
			return {true};
		},
		onClick: function(){
	...
	<div class="RegistrationBox">
		...
		<form>
			...
			<tbody>
				...
				<tr style={{fontWeight:'bold'}}><td>Address:</td></tr>
		...
		<div class="RegistrationBox">
			...
			<table>
				<tbody>
					...
					<tr>
						<td><input id="Teacher" type="checkbox"/>Teacher <input id="Student" type="checkbox"/>Student</td>
					</tr>
					<tr>
						<td><label>
